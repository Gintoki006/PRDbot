...
export default function CustomSignIn() {
  ...
  const signInWithGithub = async () => {
    ...
    setError("");
    try {
      await signIn.authenticateWithRedirect({ strategy: "oauth_github", redirectUrl: "/sso-callback", redirectUrlComplete: "/dashboard" });
    } catch (err) {
  ...
  return (
    <div className="w-full">
      <div className="text-left mb-8">
        ...
        <p className="text-[#8b949e] text-sm mt-2">Sign in to your PRDbot account</p>
      </div>
      ...
      <div className="mt-8 text-left">
        <p className="text-[#8b949e] text-sm">
          ...
          <Link href="/sign-up" className="text-white hover:text-[#58a6ff] transition-colors font-semibold">
            Sign up
          </Link>
        </p>
      </div>
